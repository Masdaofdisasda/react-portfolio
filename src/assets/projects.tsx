...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: (
      <div>
        <P>
          Ecouture is a concept for a fashion-forward, eco-friendly mobile app
          designed to promote sustainable living within the fashion industry.
          Developed as a collaborative project during a semester-long course,
          this app concept was created by a team of four, with a focus on
          addressing the environmental impact of fashion.
        </P>

        <P>
          The goal of Ecouture is to empower users to make more sustainable
          fashion choices by sharing clothes, discovering where to buy
          eco-friendly garments, and learning more about sustainable fashion
          practices. The app's design emphasizes ease of use and aesthetic
          appeal, aligning with the needs of environmentally conscious
          consumers.
        </P>
        ...
        <UL>
          <li>
            Concept Development and Pitching: I pitched the original concept for
            Ecouture, focusing on the intersection of fashion and
            sustainability.
          </li>
          <li>
            Screen Design in Figma: Designed multiple app screens in Figma,
            ensuring a seamless and visually appealing user experience that
            aligns with the app's eco-friendly ethos.
          </li>
          <li>
            Advertisement and Promotion: Contributed to the creation of an
            advertisement for the app using After Effects, with an original
            soundtrack produced in Ableton, showcasing the app's features and
            mission.
          </li>
          <li>
            Team Collaboration: Worked closely with three other team members to
            develop and refine the app concept, ensuring that it met our
            project's goals and deadlines.
          </li>
        </UL>

        <P>
          Ecouture is more than just a concept—it's a vision for how technology
          can be harnessed to promote sustainable fashion choices. This project
          showcases my skills in UX/UI design, team collaboration, and my
          ability to contribute creatively to a project from concept to final
          presentation.
        </P>
      </div>
    ),
    imageUrl: [
      '../images/ecouture1.jpg',
      '../images/ecouture2.png',
      '../images/ecouture3.png',
      '../images/ecouture4.png',
    ],
  ...
  },
  {
    ...
    description: (
      <div>
        <P>
          As part of a university group project, I collaborated with two other
          team members to develop a fully functional mail client and server
          using Java and Gradle. This project was executed in two distinct
          phases, each focusing on different aspects of email system
          functionality, from basic message handling to secure communication and
          domain management.
        </P>
        <P>
          Phase 1: Core Email System Implementation In the initial phase, we
          developed the core components of the email system, which included:
        </P>

        <UL>
          <li>
            Message Transfer Protocol (MTP): Implemented a custom protocol to
            handle the sending and receiving of emails between clients and
            servers.
          </li>
          <li>
            Message Access Protocol (MAP): Developed protocols for accessing and
            retrieving emails from the server, ensuring efficient communication
            between the client and server.
          </li>
          <li>
            Multi-Threaded Servers: Created multi-threaded transfer, mailbox,
            and monitoring servers to handle multiple client requests
            simultaneously, providing a scalable and responsive system.
          </li>
        </UL>

        <P>
          Phase 2: Enhancing Functionality and Security Building on the
          foundational work from the first phase, we introduced several advanced
          features:
        </P>
        <UL>
          <li>
            Domain Lookup Servers: Integrated domain lookup functionality to
            route emails between different domains, enhancing the system's
            versatility and real-world applicability.
          </li>
          <li>
            Secure Transfer Protocols: Added encryption to ensure secure email
            transmission, protecting user data from potential interception or
            unauthorized access.
          </li>
          <li>
            Message Integrity Checkers: Implemented mechanisms to verify the
            integrity of messages, ensuring that emails are not tampered with
            during transit.
          </li>
          <li>
            Command Line Interface (CLI): Developed a user-friendly CLI to
            interact with the email system, allowing users to send, receive, and
            manage their emails directly from the command line.
          </li>
        </UL>
        <P>
          This project not only deepened my understanding of network protocols
          and multi-threaded programming but also demonstrated the importance of
          security and data integrity in communication systems. The successful
          completion of this project reflects my ability to work effectively in
          a team, solve complex problems, and deliver a robust and secure
          software solution.
        </P>
      </div>
    ),
  ...
  },
  {
    ...
    description: (
      <div>
        <P>
          Behind the Plot Horror is a short podcast series that I co-hosted with
          two friends, where we dove into the world of bad horror movies,
          dissecting their plots, characters, and overall absurdity. This
          project was not only a fun exploration of the horror genre but also an
          opportunity for me to hone my skills in audio production and creative
          content creation.
        </P>

        <P>
          Each episode of Behind the Plot Horror featured in-depth discussions
          on various horror films, focusing on what made them both hilariously
          bad and oddly entertaining. We aimed to engage listeners with our
          lighthearted and humorous take on these films, making even the worst
          movies a joy to revisit.
        </P>
        ...
        <UL>
          <li>
            Intro and Outro Tunes: Composed and produced unique intro and outro
            tunes for the podcast, setting the tone for each episode and giving
            the show a distinctive audio identity.
          </li>
          <li>
            Fake Advertisements: Created humorous, fake advertisements that were
            interspersed throughout the episodes, adding an extra layer of
            entertainment and showcasing my creativity in audio production.
          </li>
          <li>
            Audio Mixing and Production: Took charge of the entire audio mixing
            process, using Ableton to ensure that each episode had high-quality
            sound, with balanced levels and clear dialogue.
          </li>
          <li>
            Content Creation and Hosting: Actively participated in the
            discussions, bringing insightful and often comedic perspectives to
            the analysis of the films, and helped in structuring the episodes
            for an engaging listener experience.
          </li>
        </UL>

        <P>
          Behind the Plot Horror was more than just a podcast; it was an
          exercise in creative storytelling, audio engineering, and
          collaborative content creation. This project highlights my ability to
          blend technical skills with creative passion, resulting in a polished
  ...
  },
  {
    ...
    description: (
      <div>
        <P>
          Wolum is my personal music project and artist persona, through which I
          explore and produce various genres of music, with a strong focus on
          American electronic dance music, trap, bass house, and hip-hop. Under
          the Wolum name, I have produced and released original tracks, and
          occasionally DJ, sharing my passion for high-energy beats and rhythmic
          intensity with audiences.
        </P>
        ...
        <UL>
          <li>
            Ableton Live: I primarily use Ableton Live for music production,
            leveraging its powerful tools and flexibility to create complex,
            layered tracks that reflect my personal style and influences.
          </li>
          <li>
            Genre Focus: My music production spans several genres, including
            electronic dance music (EDM), trap, bass house, and hip-hop, with
            each track designed to evoke energy and movement, perfect for both
            listening and live performances.
          </li>
        </UL>
        <H2>DJing:</H2>
        <UL></UL>
        <li>
          Rekordbox: For DJing, I use Rekordbox, a leading platform for live
          mixing and performance. This allows me to bring my tracks to life in a
          live setting, blending my original productions with other tracks to
          create unique, immersive experiences.
        </li>
        <li>
          Live Performance: Though I currently DJ less frequently, I still enjoy
          the art of live mixing, where I can connect with audiences and share
          my love for dynamic and impactful music.
        </li>

        <P>
          Wolum represents my creative outlet beyond software engineering, where
          I channel my technical skills into the art of music production and
          live performance. This project not only showcases my ability to create
          and manipulate sound but also reflects my deep passion for music and
          my commitment to continuously evolving as an artist.
        </P>
      </div>
    ),
